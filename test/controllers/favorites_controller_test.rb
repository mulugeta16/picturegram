...
class FavoritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favorite" do
    assert_difference('Favorite.count') do
      post favorites_url, params: { favorite: { User_id: @favorite.User_id, picture_id: @favorite.picture_id } }
    end
  ...
  test "should update favorite" do
    patch favorite_url(@favorite), params: { favorite: { User_id: @favorite.User_id, picture_id: @favorite.picture_id } }
